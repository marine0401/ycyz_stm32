...
#define	LCD_PWR(n)		(n?HAL_GPIO_WritePin(LCD_PWR_PORT,LCD_PWR_PIN,GPIO_PIN_SET):HAL_GPIO_WritePin(LCD_PWR_PORT,LCD_PWR_PIN,GPIO_PIN_RESET))
#define	LCD_RST(n)		(n?HAL_GPIO_WritePin(LCD_RST_PORT,LCD_RST_PIN,GPIO_PIN_SET):HAL_GPIO_WritePin(LCD_RST_PORT,LCD_RST_PIN,GPIO_PIN_RESET))
#define	LCD_WR(n)		(n?HAL_GPIO_WritePin(LCD_WR_PORT,LCD_WR_PIN,GPIO_PIN_SET):HAL_GPIO_WritePin(LCD_WR_PORT,LCD_WR_PIN,GPIO_PIN_RESET))
