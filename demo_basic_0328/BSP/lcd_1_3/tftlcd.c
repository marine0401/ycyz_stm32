...
#include "lcd_1_3/font.h"
#include "lcd_1_3/alientek_log.h"
...
static void LCD_Gpio_Init(void)
{
    ...
    HAL_GPIO_WritePin(LCD_WR_PORT, LCD_PWR_PIN|LCD_RST_PIN | LCD_WR_PIN | LCD_CS_PIN, GPIO_PIN_RESET);
...
u8 LCD_ReadWriteByte(u8 TxData)
{
    u8 Rxdata;
    HAL_SPI_TransmitReceive(&LCD_1_3_SPI,&TxData,&Rxdata,1, 1000);       
 ...
 */
u8 LCD_WriteData(u8 *TxData,u16 size)
{
	return HAL_SPI_Transmit(&LCD_1_3_SPI,TxData,size,1000);
}
